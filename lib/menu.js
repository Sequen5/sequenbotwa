...
exports.textTnC = () => {
    return `
Whatsapp : wa.me/6289689542663
Author? : Sequen

Tetap Semangat ^^, Sequen.`
}

const sosmed = '404 Not Found'

exports.textmenupenting = (pushname) => {
    return `
    ┏━━━━❉ *BOT LIST* ❉━━━━┓
Hi ${pushname}👋️, selamatt datang di Sequen Bot yang siap membantumu.
Berikut fitur yang dapat di gunakan pada bot ini✨

List menu penting Sequen Bot:

🚀 *${prefix}addbacot*
Untuk melihat bacotan member sequenbot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member sequenbot
...
2. *${prefix}donasi*
Untuk mendonasikan kepada sequen
Usage: Ketik *+donasi*.
...
15. *${prefix}getpic*
Untuk Sequen bot maling gambar orang
...
17. *${prefix}apakah*
Menanyakan sesuatu ke sequen bot
...
19. *${prefix}tomp3*
Menconvert Video/Mp4 ke music/mp3
Usage: kirim video dengan caption /tomp3
...
exports.textsongmenu = (pushname) => {
   return `
Hi ${pushname}👋️, selamat datang di Sequen Bot yang siap membantumu.
Berikut fitur yang dapat di gunakan pada bot ini✨

List lagu Sequen Bot:
┏━━━❉ *BOT Lagu* ❉━━━┓
1. *${prefix}lagu1*
Usage: ketik *+lagu1*
...
*Ketik /chat* 
*Untuk Berbicara dengan Sequen Bot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan bot chatnya*

┏━━━━❉ *BOT LIST* ❉━━━━┓
1. *${prefix}menupenting*
Menampilkan menu penting di sequenbot
Usage: ketik *+menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di sequenbot
Usage: ketik *+menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di sequenbot
Usage: ketik *+mentol*
...
7. *${prefix}lagu*
Menampilan album lagu sequenbot
Usage: ketik *+lagu*
...
Total userSequen : ${contol.length}
...
contoh: *+stickergiphy* giphy.com/sequen524
...
13 *${prefix}motivasi*
Untuk mendapatkan motivasi dari sequen bot
...
46. *${prefix}csgo*
Untuk membuat logo csgo ada teksnya
Usage: ketik +csgo teksnya

47. ${prefix}pubg*
untuk membuat logo pubg ada teksnya
Usage: ketik +pubg teks1 | teks2
...
exports.textmentol = (pushname) => {
 return `
Hi ${pushname}👋️, selamat datang di Piyobot WhatsApp pintar yang siap membantumu.
...
Contoh: +galaxytext sequenbot

29. *${prefix}glowtext*
Untuk membuat glowtext
Usage: ketik /glowtext teksnya
Contoh: +glowtext sequenbot
...
1. *+nulishd teks* = nulis di buku tulis hd
...
exports.textmenupremium = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamat datang di Sequen Bot yang siap membantumu.
...
2. *${prefix}join*
membuat bot join ke grupmu tapi ada syaratnya wkwkwkw
...
exports.textAdmin = () => {
    return `
⚠ ┏━❉ ADMIN GROUP ONLY* ❉━┓ ⚠ 
Berikut adalah fitur admin grup yang ada pada *Sequen* !
...
⚠ ┏━❉ ADMIN GROUP ONLY* ❉━┓ ⚠ 
Berikut adalah fitur owner grup yang ada pada *Sequen Bot* !
🐼 *${prefix}kickall*
...
Kirim dana seikhlasnya isi pulsa ke nomor 089689542663
